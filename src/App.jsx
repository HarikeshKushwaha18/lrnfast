...
const App = () => {
  ...
  const updateNodeContent = (tree, nodeId, content) => {
    return tree.map((node) => {
      if (node.id === nodeId) {
        return {
          ...node,
      ...
      if (node.children) {
        return {
          ...node,
          children: updateNodeContent(node.children, nodeId, content),
        };
      }
  ...
  const handleSaveContent = (nodeId, content) => {
    setData((prev) => updateNodeContent(prev, nodeId, content));
  ...
  return (
    <>
      ...
      <div className="flex">
        ...
        <Editor selectedNode={selectedNode} onSave={handleSaveContent} /> 
      </div>
    </>
  );
};
