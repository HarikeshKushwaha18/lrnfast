import { Bell, List, SearchIcon, UserPlus } from "lucide-react";
...
const Header = ({ onToggleSidebar }) => {
  ...
  return (
    <div className="flex justify-between m-4">
      ...
      <div className="w-8 h-8 bg-gray-500 text-white rounded-full flex items-center justify-center text-xl font-semibold p-2 cursor-pointer" onClick={()=>setIsOpen(true)}>AR</div>
      <UserMenu 
        isOpen={isOpen} 
